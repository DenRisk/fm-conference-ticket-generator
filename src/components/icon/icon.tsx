export type IconIds = "logoFull" | "logoMark" | "info" | "upload" | "github" | "lineBottom" | "lineTop" | "lines" | "circle"
...
const Icon = ({id, pointer = true}: IconProps) => {
    const icons = {
        logoFull: (
            <svg xmlns="http://www.w3.org/2000/svg" width="209" height="30" fill="none" viewBox="0 0 209 30">
        ...
        upload: (
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none" viewBox="0 0 30 30">
                <path fill="#F57463" fillRule="evenodd"
        ...
        github: (
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" fill="none" viewBox="0 0 22 23">
                <path fill="#D1D0D5" fillRule="evenodd"
        ...
        lineBottom: (
            <svg xmlns="http://www.w3.org/2000/svg" width="760" height="530" fill="none" viewBox="0 0 760 530">
                ...
                <defs>
                    <linearGradient id="b" x1="-1064.23" x2="824.864" y1="1.948" y2="467.112"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="446" height="208" fill="none" viewBox="0 0 446 208">
                <g clipPath="url(#a)">
                    <path fill="url(#b)"
                ...
                <defs>
                    <linearGradient id="b" x1="160.388" x2="1314.9" y1="-3.406" y2="661.838"
                                    gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity="0"/>
                        <stop offset=".48" stopColor="#F37362"/>
                        <stop offset=".905" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <clipPath id="a">
        ...
        lines: (
            <svg xmlns="http://www.w3.org/2000/svg" width="1459" height="1024" fill="none" viewBox="0 0 1459 1024">
                <path fill="url(#linea)" d="M0 0h1v1024H0z"/>
                <path fill="url(#lineb)" d="M81 0h1v1024h-1z"/>
                <path fill="url(#linec)" d="M162 0h1v1024h-1z"/>
                <path fill="url(#lined)" d="M243 0h1v1024h-1z"/>
                <path fill="url(#linee)" d="M324 0h1v1024h-1z"/>
                <path fill="url(#linef)" d="M405 0h1v1024h-1z"/>
                <path fill="url(#lineg)" d="M486 0h1v1024h-1z"/>
                <path fill="url(#lineh)" d="M567 0h1v1024h-1z"/>
                <path fill="url(#linei)" d="M648 0h1v1024h-1z"/>
                <path fill="url(#linej)" d="M729 0h1v1024h-1z"/>
                <path fill="url(#linek)" d="M810 0h1v1024h-1z"/>
                <path fill="url(#linel)" d="M891 0h1v1024h-1z"/>
                <path fill="url(#linem)" d="M972 0h1v1024h-1z"/>
                <path fill="url(#linen)" d="M1053 0h1v1024h-1z"/>
                <path fill="url(#lineo)" d="M1134 0h1v1024h-1z"/>
                <path fill="url(#linep)" d="M1215 0h1v1024h-1z"/>
                <path fill="url(#lineq)" d="M1296 0h1v1024h-1z"/>
                <path fill="url(#liner)" d="M1377 0h1v1024h-1z"/>
                <path fill="url(#lines)" d="M1458 0h1v1024h-1z"/>
                <defs>
                    <linearGradient id="linea" x1=".5" x2=".5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="lineb" x1="81.5" x2="81.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linec" x1="162.5" x2="162.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="lined" x1="243.5" x2="243.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linee" x1="324.5" x2="324.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linef" x1="405.5" x2="405.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="lineg" x1="486.5" x2="486.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="lineh" x1="567.5" x2="567.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linei" x1="648.5" x2="648.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linej" x1="729.5" x2="729.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linek" x1="810.5" x2="810.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linel" x1="891.5" x2="891.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linem" x1="972.5" x2="972.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linen" x1="1053.5" x2="1053.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="lineo" x1="1134.5" x2="1134.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="linep" x1="1215.5" x2="1215.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="lineq" x1="1296.5" x2="1296.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="liner" x1="1377.5" x2="1377.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                    <linearGradient id="lines" x1="1458.5" x2="1458.5" y1="0" y2="1024" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#fff" stopOpacity=".15"/>
                        <stop offset=".745" stopColor="#fff" stopOpacity="0"/>
                    </linearGradient>
                </defs>
    ...
    return (
        <div
            className={`flex items-center justify-center ${pointer ? "cursor-pointer" : "cursor-default"}`}>
            {icon}
        </div>
    );
};
